		...
		<section class="container-fluid" id="single_post">
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center" id="img_principale" style="background-image: url(<?php the_field('image-illu', false, false); ?>);">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
						<div id="post_cont">
							<?php the_field('information_complementaire'); ?>
						</div>
					</div>
