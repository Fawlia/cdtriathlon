	...
	<body>
			...
			<div class="container-fluid">
				<div class="container justify-content-center tabnav">
					<div class="container nav nav-tabs" id="nav-tab" role="tablist">
						<a class="nav-item nav-link natation" id="nav-natation-tab" data-toggle="tab" href="#nav-natation" role="tab" aria-controls="nav-natation" aria-selected="falseS">
							<div style="background-image:url('');"></div>
							<p>Natation</p>
						</a>
						<a class="nav-item nav-link velo" id="nav-velo-tab" data-toggle="tab" href="#nav-velo" role="tab" aria-controls="nav-velo" aria-selected="false">
							<div style="background-image:url('');"></div>
							<p>Vélo</p>
						</a>
						<a class="nav-item nav-link course" id="nav-course-tab" data-background="" data-toggle="tab" href="#nav-course" role="tab" aria-controls="nav-course" aria-selected="false">
							<div style="background-image:url('');"></div>
							<p>Course à pied</p>
						</a>
					</div>
		...
		<section class="container tab-container">
			<div class="tab-content" id="nav-tabContent">
				...
				<div class="tab-pane fade" data-back="<?php the_field('image_de_fond') ?>" data-background="<?php the_field('image_de__bouton') ?>" id="<?php the_field('id') ?>" role="tabpanel" aria-labelledby="<?php the_field('tab_lab') ?>">
					<h1 class="titre">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 card">
						<div class="border">
							<div class="grid">
								<a href="<?php the_permalink()?>" style="background-image:url(<?php the_post_thumbnail_url(); ?>); background-size:cover;background-position:center; background-repeat:no-repeat">
